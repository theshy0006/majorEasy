...
- (void)initBaseSettings {
    ...
    _unSelectedColor = [[UIColor alloc] initWithRed:0x99/255.0 green:0x99/255.0 blue:0x99/255.0 alpha:1.0];
    _selectedColor = [[UIColor alloc] initWithRed:0x05/255.0 green:0x9c/255.0 blue:0xFF/255.0 alpha:1.0];
