...
class KnownVC: BaseVC {

    let viewModel = KnownViewModel()
    ...
    func getOrderList() {
        ...
        self.viewModel.getMyFamiliarVehicles(success: { [weak self] in
...
//tableView代理实现
extension KnownVC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.addButton.setTitle("查看位置", for: .normal)
