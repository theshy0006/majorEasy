...
class QuoteVC: BaseVC {
    ...
    lazy var tableView = UITableView(frame: self.view.frame, style: .plain).then {
        ...
        $0.register(nib, forCellReuseIdentifier: "QuoteCell")
    }
    ...
    func getOrderList() {
        ...
        self.viewModel.getQuoteModel(success: { [weak self] in
...
extension QuoteVC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:QuoteCell = tableView.dequeueReusableCell(withIdentifier: "QuoteCell") as! QuoteCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        NBUtility.showTelephone(model.phoneNumber ?? "")
    }
