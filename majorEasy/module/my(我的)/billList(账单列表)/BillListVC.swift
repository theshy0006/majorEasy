...
class BillListVC: BaseVC {
    ...
    lazy var tableView = UITableView(frame: self.view.frame, style: .plain).then {
        ...
        $0.register(nib, forCellReuseIdentifier: "BillCell")
    }
    ...
    func getOrderList() {
        ...
        self.viewModel.getBill(success: { [weak self] in
...
//tableView代理实现
extension BillListVC : UITableViewDelegate, UITableViewDataSource {
