...
class RechargeVC: BaseVC {
    ...
    lazy var tableView = UITableView(frame: self.view.frame, style: .plain).then {
        ...
        let nib = UINib(nibName: "RechargeCell", bundle: nil)
        $0.register(nib, forCellReuseIdentifier: "RechargeCell")
    }
    ...
    func getOrderList() {
        ...
        self.viewModel.getRecharge(success: { [weak self] in
...
//tableView代理实现
extension RechargeVC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:RechargeCell = tableView.dequeueReusableCell(withIdentifier: "RechargeCell") as! RechargeCell
