...
class TransferOrderVC: BaseVC {

    let viewModel = TransferOrderViewModel()
...
//tableView代理实现
extension TransferOrderVC : UITableViewDelegate, UITableViewDataSource {
